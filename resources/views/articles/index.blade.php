                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-outline">
                                <input class="form-control w-100" name="title" id="notes" placeholder="Masukkan Narasi">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="notes" class="fw-bold mt-3">URL</label>
                            <div class="input-group input-group-outline">
                                <input class="form-control w-100" name="url" id="notes2" placeholder="Masukkan Narasi">
                            </div>    
                        </div>
                    </div>
            ...
            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                ...
                {{-- <div class="container">
                    <div class="w-100 d-flex justify-content-between align-items-center pb-4 ">
                        ...
                        <div class="col-md-6">
                          <div class="d-flex justify-content-end align-items-center">
                            <a href="{{ route('articles.create') }}" type="button" class="btn btn-info me-2 "><small><i class="fas fa-plus"></i></small></a>
                              <button class="btn btn-dark me-2 owl-prev"><small><i class="fas fa-chevron-left"></i></small></button>
                              <button class="btn btn-dark me-2 owl-next"><small><i class="fas fa-chevron-right"></i></small></button>
                          </div>
                        </div>
                                ...
                                <div class="item6">
                                    <div class="col-md-3 mb-4 px-2 w-100">
                                        <div class="rounded-4 card-trn">
                                            <div class="p-2">
                                                <div class="p-2">
                                                    <div class="" style="width: 100%; height: 127px;">
                                                        <img class=" w-100 h-100 object-fit-cover rounded-4" src="{{  asset('storage/'.$item->thumbnail) }}" alt="">
                                                    </div>
                                                </div>
                                                <div class="col-md-12 pt-2 ps-2">
                                                    <h6>{{ $item->judul }}</h6>
                                                ...
                                                <div class="col-md-12 my-2">
                                                    <a href="{{ route('articles.edit',$item-> id_article) }}" type="button" class="btn btn-success2 w-100">Edit</a>
                                                </div>
                                                <div class="col-md-12 my-2">
                                                    <form class="w-100" action="{{ route('articles.destroy', $item->id_article) }}" onsubmit="return confirm('Apakah Anda Ingin Menghapus Data Ini?')" method="POST">
                                                        {!! method_field('delete') . csrf_field() !!}
              ...
              <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label for="notes" class="fw-bold mt-3">Judul</label>
                        <div class="input-group input-group-outline">
                            <input class="form-control w-100" value="{{ old('title') ?? $articles->title }}" name="title" id="notes" placeholder="Masukkan Narasi">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="notes" class="fw-bold mt-3">URL</label>
                        <div class="input-group input-group-outline">
                            <input class="form-control w-100" value="{{ old('url') ?? $articles->url }}" name="url" id="notes2" placeholder="Masukkan Narasi">
                        </div>    
                    </div>
                </div>
                <label for="nama" class="fw-bold mt-3">Thumbnail</label>
