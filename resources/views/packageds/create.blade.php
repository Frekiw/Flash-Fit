        ...
        <div class="row my-3">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="{{ route('packageds.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <label for="title" class=" mt-3">Category</label>
                    <div class="input-group input-group-outline w-100">
                        <input type="text" name="category" class="form-control" id="category" placeholder="Masukkan category" >
                    </div>
                    ...
                    <div class="input-group input-group-outline w-100">
                        <input type="text" name="monthly" class="form-control" id="monthly" placeholder="Masukkan monthly">
                    </div>
                    <label for="time" class=" mt-3">Yearly</label>
                    <div class="input-group input-group-outline w-100">
                        <input type="text" name="yearly" class="form-control" id="yearly" placeholder="Masukkan yearly">
                    </div>
                    <label for="time" class=" mt-3">Benefit</label>
                    <div class="input-group input-group-outline w-100">
                        <textarea type="text" name="benefit" class="form-control" id="benefit" placeholder="Masukkan benefit"></textarea>
                    </div>
