            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center py-3">
                  ...
                  <a href="<?php echo e(route('tncs.edit',$item-> id_tnc)); ?>" class="py-1 btn btn-success mx-2 p-2 text-center">Edit TNC</a>
                </div>
                <div class="card-body ">
                    <label for="notes" class="fw-bold mt-3">Syarat Dan Ketentuan</label>
                    <div class="w-100">
                        <textarea class="form-control" name="required" id="notes" placeholder="Masukkan Narasi"><?php echo e($item->required); ?></textarea>
                    </div>
                    <label for="notes" class="fw-bold mt-3">Kebijakan Dan Privasi</label>
                    <div class="w-100">
                      <textarea class="form-control" name="policy" id="notes2" placeholder="Masukkan Narasi"><?php echo e($item->policy); ?></textarea>
                    </div>
...
<?php echo $__env->make('layouts.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\flashfit\resources\views/tncs/index.blade.php ENDPATH**/ ?>