        ...
        <div class="row my-3">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('packageds.update', $item->id_packaged)); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                    <label for="title" class=" mt-3">Category</label>
                    <div class="input-group input-group-outline w-100">
                        <input type="text" value="<?php echo e(old('category') ?? $item->category); ?>" name="category" class="form-control" id="category" placeholder="Masukkan category" >
                    </div>
                    ...
                    <div class="input-group input-group-outline w-100">
                        <input type="text" value="<?php echo e(old('monthly') ?? $item->monthly); ?>" name="monthly" class="form-control" id="monthly" placeholder="Masukkan monthly">
                    </div>
                    <label for="time" class=" mt-3">Yearly</label>
                    <div class="input-group input-group-outline w-100">
                        <input type="text" value="<?php echo e(old('yearly') ?? $item->yearly); ?>" name="yearly" class="form-control" id="yearly" placeholder="Masukkan yearly">
                    </div>
                    <label for="time" class=" mt-3">Benefit</label>
                    <div class="input-group input-group-outline w-100">
                        <textarea type="text" name="benefit" class="form-control" id="benefit" placeholder="Masukkan benefit"><?php echo e(old('benefit') ?? $item->benefit); ?></textarea>
                    </div>
...
<?php echo $__env->make('layouts.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\flashfit\resources\views/packageds/edit.blade.php ENDPATH**/ ?>