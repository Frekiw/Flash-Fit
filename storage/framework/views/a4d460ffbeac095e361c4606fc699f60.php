...
<div class="page-wrapper mdc-toolbar-fixed-adjust">
  <main class="content-wrapper">
    <?php if(session('status')): ?>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                  ...
                  <li class="breadcrumb-item">
                    <a class="" href="<?php echo e(route('cmss.index')); ?>">Cms</a>
                  </li>
                ...
                <div class="container">
                    ...
                    <div class="row">
                      <div class="owl-carousel owl-article">
                        <?php $__empty_1 = true; $__currentLoopData = $article; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="item5">
                                    ...
                                    <div class="p-2">
                                        <div class="p-2">
                                          <div class="position-relative" style="width: 100%; height: 127px;">
                                            <img class=" w-100 h-100 object-fit-cover rounded-4" style="object-position: top;" src="<?php echo e(asset('storage/'.$item->thumbnail)); ?>" alt="">
                                        ...
                                        <div class="col-md-12">
                                          <div class="d-flex justify-content-start align-items-center test2">
                                            <div class="d-flex me-1 ps-2 ">
                                                ...
                                                <small class="ms-1 text-primary"><a href="<?php echo e($item->url); ?>"><?php echo e($item->url); ?></a></small>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-md-12 my-2">
                                          <a data-bs-toggle="modal" data-bs-target="#EditModal<?php echo e($item->id_article); ?>" type="button" class="btn btn-success2 w-100">Edit</a>
                                        </div>
                                        <div class="col-md-12 my-2">
                                          <form class="w-100" action="<?php echo e(route('articles.destroy', $item->id_article)); ?>" onsubmit="return confirm('Apakah Anda Ingin Menghapus Data Ini?')" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table display">
                                ...
                                <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $article; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $articles): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-center"><?php echo e($articles->id_article); ?></td>
                                        <td class="text-center">
                                        <?php echo e($articles->title); ?>

                                        </td>
                                        <td class="text-center">
                                            <img class="rounded" style="width: 100%; object-fit:cover; height:60px" src="<?php echo e(asset('storage/'.$articles->thumbnail)); ?>" alt="">
                                        </td>
                                        <td>
                                        <div class="d-flex justify-content-center align-items-center">
                                        <a type="button" data-bs-toggle="modal" data-bs-target="#EditModal<?php echo e($articles->id_article); ?>" class="mdc-button mdc-button--outlined shaped-button outlined-button--edit mdc-ripple-upgraded mx-2"> Edit </a>
                                        <form action="<?php echo e(route('articles.destroy',$articles->id_article)); ?>" onsubmit="return confirm('Apakah Anda Ingin Menghapus Data Ini?')" method="POST">
    ...
    <div class="modal fade" id="EditModal<?php echo e($articles->id_article); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body">
                <form action="<?php echo e(route('articles.update', $articles->id_article)); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label for="notes" class="fw-bold mt-3">Judul</label>
                        <div class="input-group input-group-outline">
                            <input class="form-control w-100" value="<?php echo e(old('title') ?? $articles->title); ?>" name="title" id="title" placeholder="Masukkan Narasi">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="nama" class="fw-bold mt-3">Thumbnail</label>
                        <div class="d-flex justify-content-center align-items-center">
                            <div class="col-md-6">
                                <div class="py-2" style="width: 210px; height: 110px">
                                    <img class="w-100 h-100 object-fit-cover" src="<?php echo e(asset('storage/'.$articles->thumbnail)); ?>" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group input-group-outline">
                ...
                <label for="notes" class="fw-bold mt-3">Konten</label>
                <div class="w-100">
                    <textarea class="form-control" name="content" id="notes2" value="<?php echo e(old('content') ?? $item->content); ?>" placeholder="Masukkan Konten"><?php echo e($item->content); ?></textarea>
                </div>
                <button type="submit" class="btn btn-warning my-3">Submit</button>
                </form>
                </div>
...
<?php echo $__env->make('layouts.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\flashfit\resources\views/articles/index.blade.php ENDPATH**/ ?>